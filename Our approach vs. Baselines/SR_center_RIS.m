% This function runs the SR optimization method

function [sum_rate, complexity,theta_mat] = SR_center_RIS(K,M,N,Pt_dB,H_nonoise,H_noisy,G1_nonoise,G1_noisy,G2_nonoise,G2_noisy,sigma2,rand_ini_num,Tx_loc,Rx_loc,RIS_loc,alpha_d,alpha_d1,alpha_d2,c0_dB,opt_objective,threshold,theta_mat,noisy_cond)
