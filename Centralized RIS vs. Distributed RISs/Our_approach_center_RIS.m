% -- Our optimization appraoch based on sigmoid filled function with a centralized RIS -- %

function [our_final_rate, BF_our_ratio, SINR_opt]=Our_approach_center_RIS(K,M,N,Pt_dB,H_nonoise,G1_nonoise,G2_nonoise,sigma2,mu,r,divide_rate,ini_chance,Tx_loc,Rx_loc,RIS_loc,alpha_d,alpha_d1,alpha_d2,c0_dB,opt_objective,LN_check)
